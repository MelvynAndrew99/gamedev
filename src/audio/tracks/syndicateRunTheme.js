// syndicateRunTheme.js — "Urban Danger Zone," the campaign finale's
// cyber-metal sprint. Syndicate Run tests route memory through the sharpest
// bends, airborne lane changes, and short recovery windows, so this track
// never waits for permission: the first step lands with chug, kick, bass,
// and steel, then the arrangement keeps tightening around the player.
//
...
// acting as a launch ramp back to the tonic. 184 BPM is the fastest campaign
// tempo. 32 bars = 41.7 seconds, safely beyond the 30-second minimum.
//
